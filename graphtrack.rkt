...
(define directionhash (hash "1-12-4" #t "1-12-3" #t "1-11-7" #f "1-11-4" #f "1-22-3" #t "1-22-4" #t "1-21-4" #f "1-32-4" #t "1-31-4" #f
                            ...
                            "2-12-3" #f "2-12-4" #f "2-12-5" #f "2-12-6" #f "2-12-7" #f "2-31-6" #t "2-31-8" #t "2-32-1" #t "2-31-2" #f
...
(vector-set! nodelabels 3 "S121")(vector-set! nodelabels 14 "S122")(vector-set! nodelabels 25 "S122")(vector-set! nodelabels 19 "S201")
(vector-set! nodelabels 66 "S202")(vector-set! nodelabels 101 "S202")(vector-set! nodelabels 6 "S231")(vector-set! nodelabels 33 "S231")
(vector-set! nodelabels 28 "S232")
