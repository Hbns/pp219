...
(define D1 0)(define D2 1)(define D3 2)(define D4 3)(define S12 4)(define S32 5)(define D8 6)(define D9 7)
(define S11 8)(define D5 9)(define D6 10)(define S21 11)(define S31 12)(define D7 13)(define S22 14)

; Vector for node number to node label translation.
(define nodenames (make-vector order 0))

; Dblocks
(vector-set! nodenames 0 "D1")
(vector-set! nodenames 1 "D2")
(vector-set! nodenames 2 "D3")
(vector-set! nodenames 3 "D4")
(vector-set! nodenames 9 "D5")
(vector-set! nodenames 10 "D6")
(vector-set! nodenames 13 "D7")
(vector-set! nodenames 6 "D8")
(vector-set! nodenames 7 "D9")
; Switches
(vector-set! nodenames 8 "S11")
(vector-set! nodenames 4 "S12")
(vector-set! nodenames 11 "S21")
(vector-set! nodenames 14 "S22")
(vector-set! nodenames 12 "S31")
(vector-set! nodenames 5 "S32")

; Building the actual tree
(ug:add-edge! boomtrack2 D1 D2)
(ug:add-edge! boomtrack2 D1 S21)
(ug:add-edge! boomtrack2 D1 S22)
...
(ug:add-edge! boomtrack2 S11 D5)
(ug:add-edge! boomtrack2 S12 S31)
(ug:add-edge! boomtrack2 S12 S32)
